...
$sql = "SELECT Name as 'Video Game Name', count(*) as 'Number of Awards'
        FROM videogame v, awarded awd, awards a
...
<div class="table-container">
    ...
    ?>
        ...
        <h1>Report of the Video Games with the Number of Awards</h1>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>{$row['Video Game Name']}</td>";
