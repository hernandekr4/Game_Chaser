...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_genre'])) {
    ...
    if ($stmt->execute()) {
        ...
        $message = "Error deleting genre: " . $stmt->error;
    }
...
<body>
    ...
    ?>
        <h1>Delete Genre</h1>
        <!-- Form to delete a genre -->
        <form method="POST" action="delete_genre.php">
            <label for="genre_id">Select a Genre to Delete:</label>
            ...
            <input type="submit" name="delete_genre" value="Delete Genre">
        </form>
