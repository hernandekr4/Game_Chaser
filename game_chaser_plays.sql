...
CREATE TABLE `plays` (
  ...
  KEY `fk_game_user_id` (`GameID`),
  CONSTRAINT `fk_game_user_id` FOREIGN KEY (`GameID`) REFERENCES `videogame` (`GameID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `plays` VALUES (1,2),(3,2),(5,2);
