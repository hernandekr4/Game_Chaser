...
CREATE TABLE `awarded` (
  ...
  `GameID` int NOT NULL,
  PRIMARY KEY (`AwardID`,`GameID`),
  KEY `fk_game_award_id` (`GameID`),
  CONSTRAINT `fk_game_award_id` FOREIGN KEY (`GameID`) REFERENCES `videogame` (`GameID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `awarded` VALUES (1,1),(5,1),(1,3),(1,4),(2,4),(11,4);
